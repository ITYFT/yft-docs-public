...
```json
{
  ...
  "messagetype": {
    "clientmessage": {
      // One of client messages, e.g. { "authrequest": { "secretkey": "..." } }
    }
  }
}
```
...
```json
{
  "messageid": "b6a432e1-e268-4a90-a7e8-8e832dd2184b",
  "messageresponseid": "e4bd1a9d-02a4-43f1-a1b7-8ae328cfbfe7",
  "messagetype": {
    "servermessage": {
      "getaccountsresponse": {
        "error": "unauthorized"
...
```json
{
  "messageid": "a63f2b78-fc68-4cf5-89fc-f0c42c2e0370",
  "messageresponseid": null,
  "messagetype": {
    "servermessage": {
...
```json
{
  "messageid": "1741a4f1-c170-4a0d-9858-9a0c0f86f9dc",
  "messageresponseid": null,
  "messagetype": {
    "servermessage": {
      "positions": {
