...
This object is used to represent an entity's identifier. Depending on the client's id\_representation setting, it may contain both a UUID and a shorter Numeric ID. JSON Structure
...
```json
{
  ...
  "last_update_date": integer (timestamp in milliseconds),
  "metadata": {
    "key": "value"
  },
  "status": 0,
...
| `status`           | `int`                                                      | See [`ManagerApiAccountStatus`](#managerapiaccountstatus) enum below.                          |
| `hedge_mode`       | `int`                                                      | See [`ManagerApiAccountHedgeMode`](#managerapiaccounthedgemode) enum below.                       |
...
```json
{
  ...
  "process_id": { "uuid": "string", "num_id": "number | null" },
  "delta": "float",
  "date": integer (timestamp in milliseconds),
  "comment": "string | null",
  "reference_operation_id": { "uuid": "string", "num_id": "number | null" },
}
```
...
```json
{
  ...
  "balance_operation": { /* ManagerApiAccountBalanceUpdateOperation */ } | null
}
```
...
| Field              | Type                                                 | Description                                                         |
| ------------------ | ---------------------------------------------------- | ------------------------------------------------------------------- |
| `account`          | [`ManagerApiAccount`](#managerapiaccount)                                  | The updated account snapshot after the balance modification.        |
...
| `days_off`    | `array`   | A list of time windows representing when trading is restricted. See [`ManagerApiDayOffWindow`](#managerapidayoffwindow). |
...
| `instruments` | `object<string, `[`ManagerApiMarkupInstrument`](#managerapimarkupinstrument)`>` | Map of instrument IDs to their specific markup settings. |
...
| `margin_bidask` | [`ManagerApiBidAsk`](#managerapibidask)                                         | Bid/ask used for margin calculation.                     |
| `open_bidask`   | [`ManagerApiBidAsk`](#managerapibidask)                                         | Price when the position was opened.                      |
| `profit_bidask` | [`ManagerApiBidAsk`](#managerapibidask)                                         | Price used for PnL calculation.                          |
| `active_bidask` | [`ManagerApiBidAsk`](#managerapibidask)                                         | Most recent bid/ask price.                               |
...
| `position_id`       | `object (`[`YftManagerApiIdFull`](#yftmanagerapiidfull)`)` (opt)           | Identifier of the associated position, if applicable.        |
...
| `order_type`    | string (enum)                                              | Type of the order: `market`, `stop`, or `limit`. See [`ManagerApiOrderType`](#managerapiordertype) |
...
| `order_status`  | [ManagerApiOrderStatus](#managerapiorderstatus)            | Current status of the order (e.g. Pending, Canceled, Executed, Rejected).                                                                              |
